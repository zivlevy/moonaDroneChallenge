...
pub_socket.bind("tcp://127.0.0.1:4999")

#connect to APM throug webproxy
...
class droneCommands(WebSocket):
    ...
    def handleMessage(self):
    	...
    	if cmd_id == -1:
            ...
            msg="change heading by " + data[1]
            pub_socket.send (str(msg))
            condition_yaw(float(newHeading))
